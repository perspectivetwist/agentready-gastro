# CLAUDE.md — Agent Readiness Gastro Scanner

## Was ist dieses Projekt?
Gastro-Klon des Slipstream Agent Readiness Scanners. Prüft ob KI-Agenten auf Restaurant-Websites handeln können (reservieren, bestellen, anfragen). Teil des AI-Gastro-Hub Ökosystems.
...
## Farbschema
- Primary: #FFE600 (Gelb — Slipstream Branding)
- Background: #0A0A0A
...
## Routing
/ (Landing) → /results (Score + Aktionsplan)
