...
function getDrittel(score: number) {
  if (score >= 51) return {
    ...
    color: '#f97316',
    barWidth: 55,
    text: 'Fast agent-ready. Einzelne Aktionen blockieren noch Buchungen und Käufe.',
  }
  return {
    label: 'Unteres Drittel',
    color: '#ef4444',
    barWidth: 25,
    text: 'Über 70% deiner Branche sind agent-ready. Buchungen und Käufe laufen dort automatisch.',
  }
}
    ...
    <div className="rounded-2xl p-6 bg-white/5 border border-white/10 backdrop-blur-sm">
      ...
      <div className="w-full bg-white/10 rounded-full h-3 mb-3">
        <div
          ...
          style={{ width: `${drittel.barWidth}%`, backgroundColor: '#facc15' }}
        />
      </div>
